    ...
    const assessmentItems = [
        {
            ...
            description: "Test your technical expertise across various domains, from programming to system architecture.",
            duration: "2 hours",
            rewards: "₹10,000 cash prize"
        },
        {
            name: "CreativeGenius Test",
            description: "Unleash your creativity with challenges in graphic design, video editing, and content creation.",
            duration: "3 hours",
            rewards: "Exclusive internship opportunity"
        },
        {
            name: "Problem-Solving Quest",
            description: "Sharpen your problem-solving skills with real-world scenarios and algorithmic challenges.",
            duration: "90 minutes",
            rewards: "Certificate of Achievement"
        },
        {
            name: "Communication Mastery",
            description: "Demonstrate your communication skills through presentations, written assignments, and interviews.",
            duration: "1 hour",
  ...
  return (
    ...
    <div className="max-w-lg">
        ...
        <p className="text-gray-600 mt-2">
            Embark on a journey of skill mastery with our diverse range of assessments. Choose your challenge and elevate your career readiness today!
        </p>
    </div>
