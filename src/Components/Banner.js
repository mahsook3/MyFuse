...
export default () => {
  const slidesData = [
    ...
    },
    {
      ...
      imageUrl:
        "https://images.unsplash.com/photo-1473186664755-1c495368b58c?q=80&w=2070&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D",
      status: "completed",
    },
  ];
  ...
  return (
    <>
      <div className="max-w-2xl mx-auto text-center">
        ...
        <p className="mt-3">
          Engage in exhilarating competitions designed to ignite your passion
          and showcase your skills. Seize the opportunity to stand out and
          unlock exciting career prospects with MyFuse.
        </p>
      </div>
      <Tabs.Root
