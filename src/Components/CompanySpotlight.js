...
import COMPANYSPOTLIGHT from '../assets/COMPANYSPOTLIGHT.svg'
...
export default function CompanySpotlight() {
  return (
    <>
  {/* component */}
  <div className="bg-white relative   flex items-center  n justify-center overflow-hidden" id='spotlight'>
    <div className="relative mx-auto h-full px-4  pb-20   md:pb-10 sm:max-w-xl md:max-w-full md:px-24 lg:max-w-screen-xl lg:px-8">
      <div className="flex flex-col items-center justify-between lg:flex-row py-16">
        <div className=" relative ">
          <div className=" absolute top-0 -left-48   opacity-50 ">
            <img
              src={Resume}
          ...
          <div className="lg:max-w-xl lg:pr-5 relative">
            <p className="flex text-sm uppercase text-g1  ">COMPANY SPOTLIGHT</p>
            <h2 className="mb-6 max-w-lg text-4xl font-light leading-snug tracking-tight text-g1 sm:text-4xl sm:leading-snug">
            UNLOCKING YOUR
            ...
            In the fast-paced and competitive job market, students face the challenge of not only excelling academically but also becoming employable even before graduation. This blog aims to guide you through the journey of enhancing your employability while still studying, providing practical tips to set you on the path to a successful and fulfilling career.
            </p>
            <div className="mt-10 flex flex-col items-center md:flex-row">
              <a
                href="/"
                className="mb-3 inline-flex h-12 w-full items-center justify-center rounded bg-indigo-600 px-6 font-medium tracking-wide text-white shadow-md transition hover:bg-gray-800  focus:outline-none md:mr-4 md:mb-0 md:w-auto"
              >
                Read More
              </a>
              <a
    ...
    <div className=" absolute -bottom-24 left-10   opacity-10 ">
      <svg
        ...
        height="800px"
        viewBox="0 0 24 24"
        className="w-96   h-full    object-fill fill-gray-300 text-gray-300"
        fill="none"
        xmlns="http://www.w3.org/2000/svg"
      >
        <path
    ...
    <div className=" absolute -bottom-0 left-3/4   opacity-10 ">
      <svg
        width="800px"
        height="800px"
        viewBox="0 0 256 256"
        xmlns="http://www.w3.org/2000/svg"
        className="w-48   h-full -rotate-90   object-fill fill-red-300 text-red-300"
      >
        <path
    ...
    <div className=" absolute top-10 left-3/4   opacity-10 ">
      <svg
        fill="#000000"
        width="800px"
        height="800px"
        viewBox="0 0 256 256"
        xmlns="http://www.w3.org/2000/svg"
        className="w-96   h-full    object-fill fill-blue-300 text-blue-300"
      >
        <path
