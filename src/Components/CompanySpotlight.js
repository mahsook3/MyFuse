...
export default function CompanySpotlight() {
  return (
    <>
      <div
        className="bg-white relative   flex items-center  n justify-center overflow-hidden"
        id="spotlight"
      >
            ...
            <div className=" relative ">
              ...
              <div className="lg:max-w-xl lg:pr-5 relative">
                ...
                <p className="text-base text-gray-700">
                  In the fast-paced and competitive job market, students face
                  the challenge of not only excelling academically but also
                  becoming employable even before graduation. This blog aims to
                  guide you through the journey of enhancing your employability
                  while still studying, providing practical tips to set you on
                  the path to a successful and fulfilling career.
                </p>
                <div className="mt-10 flex flex-col items-center md:flex-row">
                  <a
                    href="/"
                    className="mb-3 inline-flex h-12 w-full items-center justify-center rounded bg-indigo-600 px-6 font-medium tracking-wide text-white shadow-md transition hover:bg-gray-800  focus:outline-none md:mr-4 md:mb-0 md:w-auto z-50"
                  >
                    Read More
                  </a>
                  <a
