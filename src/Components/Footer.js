        ...
        <footer className="pt-10 bg-gray-800">
            <div className="max-w-screen-xl mx-auto px-4 md:px-8">
                ...
                <div className="space-y-6">
                        <img src="https://www.myfuse.in/assets/img/MyFuse2.png" className="w-32" />
                        <p className="max-w-md text-gray-100">
                        Bridging the Gap Between Students and Job Opportunities in India
                        </p>
                ...
                <div className="mt-10 py-10 border-t border-gray-700 items-center justify-between sm:flex">
                    <p className="text-gray-300">© {new Date().getFullYear()} MyFuse.In. All rights reserved.</p>
