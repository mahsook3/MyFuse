...
export default function Hero() {
    ...
    const [heroData, setHeroData] = useState([
        {
            ...
            description: "Bridging the Gap Between Students and Job Opportunities in India and Discover a world of endless opportunities and jumpstart your career journey with MyFuse.In.",
            buttons: [
                {
        ...
        // Data 2
        {
            ...
            description: "Your dream job is just a click away. Explore the latest job opportunities in India and find the perfect job that suits your skills and interests.",
            buttons: [
                {
                    text: "Sign Up Now",
                    color: "white",
        ...
        // Data 3
        {
            ...
            description: "Discover the latest job opportunities in India and find the perfect job that suits your skills and interests. Sign up now and explore the world of endless opportunities.",
            buttons: [
                {
                    text: "Sign Up Now",
                    color: "white",
    ...
    {heroData.map((_, index) => (
        <button
            key={index}
            className={`w-8 h-1 mx-2 rounded-full focus:outline-none ${currentIndex === index ? 'bg-gray-800' : 'bg-gray-400'}`}
