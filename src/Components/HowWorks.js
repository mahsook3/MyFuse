      ...
      <div className="relative flex flex-col justify-center overflow-hidden bg-gray-50 p-10">
        <div className="max-w-xl sm:text-center md:mx-auto">
          ...
          <p className="mt-3 text-gray-900 mb-5">
            MyFuse is designed to help you discover the right job for you.
            Myfuse welcomes applicants with no work experience, providing
            valuable opportunities and resources. Myfuse's straightforward
            application process is designed to be easy to apply.
          </p>
        </div>
