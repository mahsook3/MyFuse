...
<div className="p-10" style={{
    ...
    opacity: 0.8,
    backgroundImage: 'radial-gradient(#444cf7 0.5px, transparent 0.5px), radial-gradient(#444cf7 0.5px, rgb(249, 250, 251) 0.5px)',
    backgroundSize: '20px 20px',
    backgroundPosition: '0 0,10px 10px'
}}>     <section className="max-w-xl mt-12 mx-auto px-4 md:px-8 mb-10">
