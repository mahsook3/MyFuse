...
export default () => {
  const testimonials = [
    {
      avatar:
        "https://www.iimb.ac.in/sites/default/files/inline-images/Shreya%20Saraiwala.JPG",
      name: "Sneha Kumari",
      title: "SDE",
      quote:
        "With the help of Myfuse, I was able to land my dream job as a software developer. The messaging feature allowed me to connect directly with HR representatives and clarify any doubts I had, making the job application process so much easier.",
    },
    {
      avatar: "https://www.myfuse.in/rahul.jpeg",
      name: "Rahul Paul",
      title: "UI/UX Designer",
      quote:
        "Myfuse offered me a wide range of job opportunities across various industries. I was able to use the messaging feature to communicate with HR of companies directly, making the job application process seamless and hassle-free.",
    },
    {
      avatar: "https://abs.edu.in/wp-content/uploads/2017/11/gunjan_sharma.jpg",
      name: "Prerna Sinha",
      title: "Consultant",
      quote:
        "As a fresher without much experience, job hunting was overwhelming. Myfuse offered me opportunities that matched my skill set and experience, making it easier for me to start my career in the field of marketing and others.",
    },
  ];
    ...
    <section className="relative py-14">
      <div className="relative z-10 max-w-screen-xl mx-auto px-4 md:px-8">
        <div className="max-w-xl sm:text-center md:mx-auto">
          ...
          <p className="mt-3 text-gray-100 mb-5">
            Discover what our satisfied customers have to say about their
            experiences with our products and services. Read these testimonials
            to gain insights into the positive impact we've had on their lives
          </p>
        </div>
        <Slider {...sliderSettings} ref={sliderRef}>
          {testimonials.map((item, idx) => (
            <div key={idx}>
              <div className="bg-white rounded-xl border shadow-md p-8 mr-3">
                {" "}
                <div className="p-4">
                  <svg
                ...
                <figure>
                  ...
                  <div className="flex items-center gap-x-4 p-4 mt-6 bg-indigo-50 rounded-lg">
                    <img
                      src={item.avatar}
                      alt={item.name}
                      className="w-16 h-16 rounded-full border-2 border-indigo-500 object-cover object-center"
                    />
                    <div>
